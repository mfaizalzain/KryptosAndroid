...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    private final ScubaLibraryAccessors laccForScubaLibraryAccessors = new ScubaLibraryAccessors(owner);
    ...
    /**
     * Dependency provider for <b>jmrtd</b> with <b>org.jmrtd:jmrtd</b> coordinates and
     ...
     */
    @Deprecated
    public Provider<MinimalExternalModuleDependency> getJmrtd() {
    ...
    /**
     * Group of libraries at <b>scuba</b>
     *
     * @deprecated Will be removed in Gradle 9.0.
     */
    @Deprecated
    public ScubaLibraryAccessors getScuba() {
        org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
        return laccForScubaLibraryAccessors;
    }
    ...
    public static class BouncycastleLibraryAccessors extends SubDependencyFactory {
        ...
        /**
         * Dependency provider for <b>prov</b> with <b>org.bouncycastle:bcprov-jdk15to18</b> coordinates and
        ...
        /**
         * Dependency provider for <b>util</b> with <b>org.bouncycastle:bcutil-jdk15to18</b> coordinates and
         * with version reference <b>bouncycastle</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
        ...
        public Provider<MinimalExternalModuleDependency> getUtil() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("bouncycastle.util");
        }
    ...
    public static class MlkitDocumentLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>mlkitDocScanner</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
     ...
     */
    @Deprecated
    public static class ScubaLibraryAccessors extends SubDependencyFactory {
        private final ScubaScLibraryAccessors laccForScubaScLibraryAccessors = new ScubaScLibraryAccessors(owner);

        public ScubaLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>scuba.sc</b>
         *
         * @deprecated Will be removed in Gradle 9.0.
         */
        @Deprecated
        public ScubaScLibraryAccessors getSc() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return laccForScubaScLibraryAccessors;
        }
     ...
     */
    @Deprecated
    public static class ScubaScLibraryAccessors extends SubDependencyFactory {

        public ScubaScLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>android</b> with <b>net.sf.scuba:scuba-sc-android</b> coordinates and
        ...
        public Provider<MinimalExternalModuleDependency> getAndroid() {
            org.gradle.internal.deprecation.DeprecationLogger.deprecateBehaviour("Accessing libraries or bundles from version catalogs in the plugins block.").withAdvice("Only use versions or plugins from catalogs in the plugins block.").willBeRemovedInGradle9().withUpgradeGuideSection(8, "kotlin_dsl_deprecated_catalogs_plugins_block").nagUser();
            return create("scuba.sc.android");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>jmrtd</b> with value <b>0.7.42</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>mlkitDocScanner</b> with value <b>16.0.0-beta1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getMlkitDocScanner() { return getVersion("mlkitDocScanner"); }
        ...
        /**
         * Version alias <b>scuba</b> with value <b>0.0.23</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
